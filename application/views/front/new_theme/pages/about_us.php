                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="about-box-layout1">
                            ...
                            <h2 class="item-title">Household Appliance Services You Can Trust</h2>
                            <p>When it comes to finding an appliance company you can trust in your home, Omkar Cool Services meets all the qualifications. We also make sure to only employ highly qualified professionals you can depend on.</p>
                            <div class="list-item">
                                <ul>
                                    <li>
                                        <h3>Appliances Repair & Services</h3>
                                        <p>At Omkar Cool Services we repair & services all types of home appliances.</p>
                                    </li>
                                    <li>
                                        <h3>Annual Maintenance Contract</h3>
                                        <p>Omkar Cool Services offers an reliable & cost effective AMC package for domestic & commercial needs</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="about-box-layout6">
                            <div class="item-img">
                                <img src="<?php echo base_url();?>assets/img/who.jpg" alt="thumb">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="why-choose-box-layout2">
                            ...
                            <div class="item-content">
                                <h3 class="item-title">Expert Technician</h3>
                                <p></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="team-box-layout1">
                            <div class="item-img">
                                <img src="<?php echo base_url();?>assets/img/team/team2.png" alt="team-thumb">
                            </div>
                            <div class="item-content">
                ...
                <div class="row">
                    <div class="col-lg-4 single-process">
                        <div class="process-box-layout1">
                            <div class="item-bg">
                                <img src="<?php echo base_url();?>assets/img/figure/bubble5.png" alt="thumb">
                                <div class="item-icon">
