document.onscroll = function(){
    ...
    contentBoxHeight = contentBox.offsetHeight;
    pageY = window.pageYOffset;
    th = 500;
    if (pageY>= th && pageY <= contentBoxHeight){
      $('#contact-form-widget').addClass('floating-form');
    }
    if (pageY >= contentBoxHeight+200 || pageY <= th){
        $('#contact-form-widget').removeClass('floating-form');
    }
};
(function ($) {
    "use strict";
    ...
    if (contactForm.length) {
        contactForm.validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url: base_url+"ajax/contact-form",
                    type: "POST",
    ...
    if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='"+base_url+"'><img src='"+base_url+"assets/img/logo.png' alt='logo' class='img-fluid'/></a></div>"
        });
    }
